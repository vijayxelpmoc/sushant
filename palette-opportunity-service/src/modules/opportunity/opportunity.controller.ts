...
export class OpportunityController {
  constructor(
    ...
    private readonly opportunityServiceNew: OpportunityServiceNew,
  ) {}
   ...
   * @returns {Object} status code and message
   */
  @hasRoles(Role.Parent, Role.Advisor, Role.Faculty, Role.Administrator)
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Post('multi')
  ...
  async getShareRecipients(
    ...
    return await this.opportunityServiceNew.getOppShareRecipients(
      req.user.id,
