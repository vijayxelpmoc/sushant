...
//     const advisor = await this.advisorService.getAdvisorDetailsStudents(userId);
...
//           instituteId,
//         );
//         console.log('advisorObservers', advisorObservers);
...
//       '*',
//       {
//         Account: advisorInstituteDetails[0].Account,
//         Role: ['Admin'],
//       },
//       {},
//       instituteId,
...
//     const parent = await this.parentService.getParent(userId);
...
//     // doubt
//     const observer = await this.observerService.getObserverDetails(userId);
//     const institute = await this.sfService.models.affiliations.get('*', {
//       Contact: userId,
//       Affiliation_Type: 'Educational Institution',
//     });

//     const observerInstituteId = institute[0].Account;

//     const observerInsti = await this.sfService.models.affiliations.get('*', {
//       Account: observerInstituteId,
...
//         instituteId,
//       );
//       for (let i = 0; i < adminMentorsList.length; i++) {
